    ...
    <header className="relative z-50 w-full px-6 py-4">
      <div className="flex items-center justify-between max-w-7xl mx-auto">
        ...
        <div className="flex items-center space-x-2">
          ...
          <span className="text-xl font-bold"><img src="images/main_logo.png" alt="inline_logo" className="w-[160px] h-[120px]" />
</span>
        ...
        <nav className="hidden md:flex items-center space-x-6">
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent className="bg-white border border-gray-200 shadow-lg rounded-md p-1 z-50">
              ...
              <DropdownMenuItem asChild>
                <a href="wallet.luxeports.com" target="_blank" rel="noopener noreferrer" className="flex items-center space-x-2 px-3 py-2 hover:bg-gray-100">
                  <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
